...
import 'dart:ui';
// RoleService import not needed in this screen
...
class BadgesPointsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Use MediaQuery if needed in the future; no local use required now
...
// Drawer removed; AppScaffold manages responsive sidebar/drawer